...
type MeetingParticipantsQos struct {
	...
	UserQos    UserQos `json:"user_qos"`
}
type UserQos []Userqos
type Userqos struct {
	AsDeviceFromCrc    AsDeviceFromCrc    `json:"as_device_from_crc"`
	AsDeviceToCrc      AsDeviceToCrc      `json:"as_device_to_crc"`
	AsInput            AsInput            `json:"as_input"`
	AsOutput           AsOutput           `json:"as_output"`
	AudioDeviceFromCrc AudioDeviceFromCrc `json:"audio_device_from_crc"`
	AudioDeviceToCrc   AudioDeviceToCrc   `json:"audio_device_to_crc"`
	AudioInput         AudioInput         `json:"audio_input"`
	AudioOutput        AudioOutput        `json:"audio_output"`
	CPUUsage           CPUUsage           `json:"cpu_usage"`
	VideoDeviceFromCrc VideoDeviceFromCrc `json:"video_device_from_crc"`
	VideoDeviceToCrc   VideoDeviceToCrc   `json:"video_device_to_crc"`
	VideoInput         VideoInput         `json:"video_input"`
...
func (z *Zoom) GetDashboardMeetingParticipants(meeting_id string, participant_id string) (MeetingParticipantsQos, error) {
